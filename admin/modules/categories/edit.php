              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea id="inputDescription" class="form-control"
                    rows="4">Cà phê truyền thống là thức uống được pha chế từ những hạt cà phê chất lượng cao, thường được pha theo các phương pháp truyền thống như phin, pha máy hoặc pha tay. Mỗi tách cà phê mang đến hương vị đặc trưng, thơm ngon và đậm đà, tạo nên sự hấp dẫn và cuốn hút đặc biệt trong nền văn hóa cà phê của mỗi quốc gia.</textarea>
                </div>
                <div class="form-group">
