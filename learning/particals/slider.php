<div id="carouselMainSlider" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="../learning/assets/imges/Thiet-ke-chua-co-ten.webp" class="d-block w-100" alt="...">
				</div>
				<div class="carousel-item">
					<img src="../learning/assets/imges/1900x750-2.webp" class="d-block w-100" alt="...">
				</div>
				<div class="carousel-item">
					<img src="../learning/assets/imges/900x600-FPT-Polytechnic-Hoc-bong-phat-trien-nguon-nhan-luc.webp" class="d-block w-100" alt="...">
				</div>
			</div>
